...
struct Command commands[] =
{
		...
		{ "schedPRIRR", "Command for scheduler" ,command_schedPRIRR , 3},
		//**************************************//
...
int command_schedPRIRR(int number_of_arguments, char **arguments){
	...
	uint8 numberOfPriorities= strtol(arguments[1],NULL, 10);
	uint8 quantumValue= strtol(arguments[2],NULL, 10);
	uint32 starvThreshValue= strtol(arguments[3],NULL, 10);
	sched_init_PRIRR(numberOfPriorities,quantumValue,starvThreshValue);
	return 0;
}
